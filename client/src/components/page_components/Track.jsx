    ...
    <div>
      {isPlaying && (
        <div className="bg-gray-200 p-4 mb-4">
          <h1 className="text-lg font-bold">Now playing: {track?.trackName}</h1>
      ...
      <div>
        ...
        {active === "track" && (
          <div className="flex justify-start space-x-2 ">
            <button track={track} setActive={setActive}></button>
            <button
            ...
            <div className="min-w-500">
              <h1 className="text-lg font-bold ">{track?.trackName}</h1>
            </div>
